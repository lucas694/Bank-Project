  ...
  return (
    <div className={"HeroContainer"}>
      <div className={"HeroLeft"}>
        ...
        <ul className={"UlHero"}>
          <Li LiClass={"LiComp"} LiIcon={<FaCheckCircle className={"IconCheckWhite"}/>} Text={"Instant Transfer"}/>
          <Li LiClass={"LiComp"} LiIcon={<FaCheckCircle className={"IconCheckWhite"}/>} Text={"Saving Accounts"}/>
          <Li LiClass={"LiComp"} LiIcon={<FaCheckCircle className={"IconCheckWhite"}/>} Text={"Payments woldwide"}/>
          <Li LiClass={"LiComp"} LiIcon={<FaCheckCircle className={"IconCheckWhite"}/>} Text={"100% mobile banking"}/>
        </ul>
